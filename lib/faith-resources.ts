...
export const FAITH_RESOURCES: FaithResource[] = [
  ...
  {
    id: "gq-bible-work",
    title: "GotQuestions — 성경은 일에 대해서 어떻게 이야기하나요?",
    href: "https://www.gotquestions.org/Korean/Korean-Bible-work.html",
    source: "GotQuestions",
    language: "ko",
    kind: "article",
    level: "intro",
    topics: ["work", "vocation", "business", "calling", "meaning"],
    questions: { ko: ["사업은 어떻게 하면 될까요?", "일과 직업을 성경적으로 어떻게 봐야 하나요?"], en: ["What does the Bible say about work?", "How should Christians think about vocation?"] },
    summary: { ko: "일, 목적, 사업과 수고의 의미를 성경적 관점에서 검토하는 GotQuestions 한국어 자료입니다.", en: "Korean GotQuestions article on work, purpose, business, and meaning." },
  },
  {
    id: "gq-christian-careers",
    title: "GotQuestions — 크리스천은 어떤 직업을 가져야 할까요?",
    href: "https://www.gotquestions.org/Korean/Korean-Christian-careers.html",
    source: "GotQuestions",
    language: "ko",
    kind: "article",
    level: "intro",
    topics: ["work", "vocation", "career", "calling", "discernment"],
    questions: { ko: ["크리스천은 어떤 직업을 가져야 하나요?", "직업 선택을 어떻게 분별하나요?"], en: ["What career should a Christian choose?", "How should Christians discern work?"] },
    summary: { ko: "직업 선택과 소명을 교회 안 일로만 제한하지 않고 신앙적으로 분별하도록 돕는 GotQuestions 한국어 자료입니다.", en: "Korean GotQuestions article on Christian career discernment beyond church-only work." },
  },
  {
    id: "gq-finances",
    title: "GotQuestions — 성경은 재정 관리에 대해 무엇이라고 말하는가?",
    href: "https://www.gotquestions.org/korean/korean-finances.html",
    source: "GotQuestions",
    language: "ko",
    kind: "article",
    level: "intro",
    topics: ["money", "finance", "business", "stewardship", "debt", "generosity"],
    questions: { ko: ["돈과 재정을 어떻게 다뤄야 하나요?", "사업과 재정 결정을 어떻게 분별하나요?"], en: ["What does the Bible say about finances?", "How should Christians handle money?"] },
    summary: { ko: "돈, 빚, 재정 관리, 청지기직을 성경적 원칙으로 검토하는 GotQuestions 한국어 자료입니다.", en: "Korean GotQuestions article on money, debt, financial management, and stewardship." },
  },
  {
    id: "ssb-internal",
...
export const FAITH_QUESTION_NODES: FaithQuestionNode[] = [
  ...
  {
    id: "work-stewardship",
    title: { ko: "일과 사업은 어떻게 분별해야 하는가?", en: "How should work and business be discerned?" },
    shortAnswer: {
      ko: "성경은 일과 사업을 성공 가능성만이 아니라 주께 하듯 하는 태도, 정직, 재정 청지기직, 염려와 탐욕의 점검 안에서 분별하게 합니다.",
      en: "Scripture frames work and business not only by success but by service before the Lord, honesty, stewardship, and watchfulness over anxiety and greed.",
    },
    topics: ["work", "business", "vocation", "money", "stewardship"],
    keywords: { ko: ["사업", "창업", "직업", "직장", "일", "재정", "돈", "청지기", "진로"], en: ["business", "startup", "work", "career", "vocation", "money", "finance", "stewardship"] },
    passages: [
      { label: "Colossians 3:23–24", reference: { code: "COL", chapter: 3, startVerse: 23, endVerse: 24 }, note: { ko: "무슨 일을 하든 주께 하듯 하라는 기준을 줍니다.", en: "Frames all work as service before the Lord." } },
      { label: "Proverbs 16:3", reference: { code: "PRO", chapter: 16, startVerse: 3, endVerse: 3 }, note: { ko: "일을 여호와께 맡기라는 지혜의 원칙입니다.", en: "A wisdom principle for committing work to the Lord." } },
      { label: "Matthew 6:24–34", reference: { code: "MAT", chapter: 6, startVerse: 24, endVerse: 34 }, note: { ko: "돈과 염려가 판단을 지배하지 않도록 점검합니다.", en: "Tests whether money and anxiety are ruling discernment." } },
    ],
    resourceIds: ["gq-bible-work", "gq-christian-careers", "gq-finances"],
    nextQuestions: { ko: ["돈을 어떻게 다뤄야 하는가?", "직업 선택을 어떻게 분별하는가?"], en: ["How should money be handled?", "How should a career be discerned?"] },
  },
  {
    id: "humanity",
