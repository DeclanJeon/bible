...
const DOCTRINAL_ROUTING_RULES = [
  ...
  },
  {
    ...
    primaryReference: { code: "LUK", chapter: 23, startVerse: 43, endVerse: 43 } satisfies BibleReference,
    supportingReferences: [
  ...
  {
    match: /(부활).*(살아있는|살아 남|산 자)|((살아있는|살아 남|산 자).*(부활))/i,
    primaryReference: { code: "1CO", chapter: 15, startVerse: 51, endVerse: 52 } satisfies BibleReference,
    supportingReferences: [
  ...
  },
  {
    ...
    primaryReference: { code: "JOH", chapter: 11, startVerse: 25, endVerse: 26 } satisfies BibleReference,
    supportingReferences: [
  ...
  {
    match: /(천국).*(못 들어|들어갈 수 있나)|((구원받은|구원).*(천국|하늘나라))/i,
    primaryReference: { code: "MAT", chapter: 7, startVerse: 21, endVerse: 21 } satisfies BibleReference,
    supportingReferences: [
  ...
  {
    match: /(사랑하는 사람|사람이).*(죽어서|죽었|죽음|슬퍼)|((죽어서|죽음|슬퍼).*(사랑하는 사람|사람이))/i,
    primaryReference: { code: "1TH", chapter: 4, startVerse: 13, endVerse: 18 } satisfies BibleReference,
    supportingReferences: [
      { code: "JOH", chapter: 11, startVerse: 25, endVerse: 26 },
  ...
  {
    match: /(침묵|응답이 없|기도해도|잠잠).*(하나님)|((하나님).*(침묵|기도해도|잠잠))/i,
    primaryReference: { code: "PSA", chapter: 13, startVerse: 1, endVerse: 2 } satisfies BibleReference,
    supportingReferences: [
  ...
  },
  {
    ...
    primaryReference: { code: "1JO", chapter: 1, startVerse: 9, endVerse: 9 } satisfies BibleReference,
    supportingReferences: [
  ...
  {
    match: /(부르심|두렵|미래|감당).*(모르겠|무섭)|((모르겠|무섭).*(부르심|두렵|미래))/i,
    primaryReference: { code: "JOS", chapter: 1, startVerse: 9, endVerse: 9 } satisfies BibleReference,
    supportingReferences: [
  ...
  },
  {
    ...
    primaryReference: { code: "JAM", chapter: 1, startVerse: 5, endVerse: 5 } satisfies BibleReference,
    supportingReferences: [
  ...
  {
    match: /(용서하기|배신한|원수|분노|원망).*(힘들|어려)|((힘들|어려).*(용서|배신))/i,
    primaryReference: { code: "MAT", chapter: 18, startVerse: 21, endVerse: 22 } satisfies BibleReference,
    supportingReferences: [
