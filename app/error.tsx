  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-8 lg:px-8">
      <div className="glass rounded-[32px] p-8 text-center lg:p-10 max-w-lg">
        <div className="text-5xl font-bold text-[var(--gold)]">⚠</div>
        ...
        <button
          onClick={reset}
          className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-[var(--accent)] px-6 py-3 text-sm font-semibold text-slate-950 hover:bg-[var(--accent)]/90 transition"
        >
          Try again
        </button>
      </div>
