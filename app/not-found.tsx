  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-6xl flex-col items-center justify-center px-6 py-8 lg:px-8">
      <div className="glass rounded-[32px] p-8 text-center lg:p-10 max-w-lg">
        ...
        <h1 className="mt-6 text-2xl font-bold text-[var(--ink)]">Page not found</h1>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link
            href="/ko"
            className="rounded-2xl bg-[var(--gold)] px-5 py-3 text-sm font-semibold text-[var(--canvas)] hover:bg-[var(--gold-hover)] transition"
          >
            Go home
          </Link>
          <Link
            href="/ko/lanes"
            className="rounded-2xl border border-[var(--hairline)] px-5 py-3 text-sm font-semibold text-[var(--ink)] hover:border-[var(--gold)]/30 hover:text-[var(--gold)] transition"
          >
            Browse lanes
          </Link>
        </div>
