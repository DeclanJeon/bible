...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: localizedUrl("ko", "/faith-questions"), lastModified: now, changeFrequency: "monthly", priority: 0.78 },
    { url: localizedUrl("en", "/faith-questions"), lastModified: now, changeFrequency: "monthly", priority: 0.68 },
