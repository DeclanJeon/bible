const PASSTHROUGH_ENV_KEYS = [
  ...
  "LETTERS_CARD_IMAGE_DRIVE_FOLDER_ID",
  "LETTERS_N8N_IMAGE_UPLOAD_URL",
  "LETTERS_N8N_IMAGE_UPLOAD_TOKEN",
  "LETTERS_CARD_IMAGE_UPLOAD_WEBHOOK_URL",
  "LETTERS_GOOGLE_DRIVE_PUBLIC_URL_TEMPLATE",
  "LETTERS_GOOGLE_DRIVE_REFRESH_TOKEN",
  "LETTERS_GOOGLE_DRIVE_OAUTH_CLIENT_ID",
  "LETTERS_GOOGLE_DRIVE_OAUTH_CLIENT_SECRET",
